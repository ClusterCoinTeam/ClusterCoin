...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ClusterCoin"),
     ...
     * override -datadir in the clustercoin.conf file in the default data directory
     * (to be consistent with clustercoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
